...
class TwitterHelper{
    ...
    //------------------------------------------------------------------
    // 新規ポジションの場合のツイート文を作成
    void TwitterHelper::NewOrderTweet(int orderNo,string symbol, string orderType, double price, string type)
    {
        string tweetStr = "";
    ...
    //------------------------------------------------------------------
    // ポジション解消の場合のツイート分を作成
    void TwitterHelper::SettementOrderTweet(int orderNo,string symbol, string orderType, double price, double profits, string type)
    {
        string tweetStr = "";
    ...
    void TwitterHelper::ExecTradeTweet(string tweetStr){
        if (IsDllsAllowed()) {
    ...
    //------------------------------------------------------------------
    // Twitterへの書き込み(なんでも)
    void TwitterHelper::ExecTweet(string tweetStr){
        if (IsDllsAllowed()) {
